...
# acquires the lock for this tick actually runs it, and the rest skip. A
# lease (not a lock held for the tick's duration and explicitly released)
# so a replica that crashes mid-tick can't strand the lock forever; it just
